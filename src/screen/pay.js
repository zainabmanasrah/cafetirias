...
<ImageBackground  source={require('../assets/tr.png')} 
style={{ width:420,marginTop:1,height:170,}}>
...
<TextInput  style={TransmissionStyle.input} placeholder='كافتيريا جامعة بوليتكنك فلسطين' />
 ...
 <Text style={{marginLeft:170,
    ...
    <TouchableOpacity style={{backgroundColor:"#9A4726", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:50,borderRadius:20}} onPress={callFun2}>
     <Text style={{textAlign:'center',color:"white",justifyContent:"space-around",fontSize:20}} >تأكيد</Text>
     </TouchableOpacity>
     <TouchableOpacity style={{backgroundColor:"#FAF4EE", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:40,borderRadius:20}} >
