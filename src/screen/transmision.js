...
height:190,marginRight:100}}>
 ...
 <TouchableOpacity style={{backgroundColor:"#9A4726", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:30,borderRadius:20}} onPress={callFun2 }>
<Text style={{textAlign:'center',color:"white",justifyContent:"space-around",fontSize:20}} >تأكيد</Text>
</TouchableOpacity>
<TouchableOpacity onPressIn={callFun2} style={{backgroundColor:"#FDE9D9", paddingVertical:10,marginTop:20,width:130,height:45,marginLeft:60,borderRadius:20}} onPress={callFun2 }>
